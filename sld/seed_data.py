...
def get_default_sld_schema():
    ...
    cells.append(make_cell(
        ...
        {'type': 'TR_2W', 'name': '22.9/0.4kV TR#2', 'priVoltage': 22.9, 'secVoltage': 0.4, 'connection': 'Δ-Y', 'capacity': '1000kVA', 'color': '#059669'}
    ))
    ...
    cells.append(make_cell(
        ...
        {'type': 'BUSBAR', 'name': '0.4kV 모선 (A)', 'voltage': 0.4, 'voltageUnit': 'kV', 'color': '#059669'},
    ...
    cells.append(make_link('link-tr2-bus04a', 'tr-2', 'sec', 'bus-04-a', 'p_tr', '#059669'))

    # Sub-loads on 0.4kV Bus A (Columns: 220, 280, 340)
    cells.append(make_cell('acb-a1', 'sld.ACB', 206, 615, 28, 40, {'type': 'CB_ACB', 'name': 'ACB', 'state': 'LIVE', 'voltage': 0.4, 'current': 1600, 'color': '#059669', 'location': '0.4kV 모선 (A)'}))
    cells.append(make_cell('load-a1', 'sld.Load', 203, 680, 34, 36, {'type': 'LOAD', 'name': '부하', 'color': '#059669'}))
    cells.append(make_link('link-busa-acba1', 'bus-04-a', 'p1', 'acb-a1', 'in', '#059669'))
    cells.append(make_link('link-acba1-loada1', 'acb-a1', 'out', 'load-a1', 'in', '#059669'))

    cells.append(make_cell('mccb-a2', 'sld.MCCB', 266, 615, 28, 40, {'type': 'CB_MCCB', 'name': 'MCCB', 'state': 'LIVE', 'voltage': 0.4, 'current': 225, 'color': '#059669'}))
    cells.append(make_cell('load-a2', 'sld.Load', 263, 680, 34, 36, {'type': 'LOAD', 'name': '부하', 'color': '#059669'}))
    cells.append(make_link('link-busa-mccba2', 'bus-04-a', 'p2', 'mccb-a2', 'in', '#059669'))
    cells.append(make_link('link-mccba2-loada2', 'mccb-a2', 'out', 'load-a2', 'in', '#059669'))

    cells.append(make_cell('mccb-a3', 'sld.MCCB', 326, 615, 28, 40, {'type': 'CB_MCCB', 'name': 'MCCB', 'state': 'LIVE', 'voltage': 0.4, 'current': 225, 'color': '#059669'}))
    cells.append(make_cell('load-a3', 'sld.Load', 323, 680, 34, 36, {'type': 'LOAD', 'name': '부하', 'color': '#059669'}))
    cells.append(make_link('link-busa-mccba3', 'bus-04-a', 'p3', 'mccb-a3', 'in', '#059669'))
    cells.append(make_link('link-mccba3-loada3', 'mccb-a3', 'out', 'load-a3', 'in', '#059669'))
    ...
    cells.append(make_cell(
        ...
        {'type': 'TR_2W', 'name': '22.9/0.4kV TR#3', 'priVoltage': 22.9, 'secVoltage': 0.4, 'connection': 'Δ-Y', 'capacity': '1000kVA', 'color': '#059669'}
    ))
    ...
    cells.append(make_cell(
        ...
        {'type': 'BUSBAR', 'name': '0.4kV 모선 (B)', 'voltage': 0.4, 'voltageUnit': 'kV', 'color': '#059669'},
    ...
    cells.append(make_link('link-tr3-bus04b', 'tr-3', 'sec', 'bus-04-b', 'p_tr', '#059669'))

    # Sub-loads on Bus B (Columns: 430, 490, 550)
    cells.append(make_cell('mccb-b1', 'sld.MCCB', 416, 615, 28, 40, {'type': 'CB_MCCB', 'name': 'MCCB', 'state': 'LIVE', 'voltage': 0.4, 'color': '#059669'}))
    cells.append(make_cell('load-b1', 'sld.Load', 413, 680, 34, 36, {'type': 'LOAD', 'name': '부하', 'color': '#059669'}))
    cells.append(make_link('link-busb-mccbb1', 'bus-04-b', 'p1', 'mccb-b1', 'in', '#059669'))
    cells.append(make_link('link-mccbb1-loadb1', 'mccb-b1', 'out', 'load-b1', 'in', '#059669'))

    cells.append(make_cell('mccb-b2', 'sld.MCCB', 476, 615, 28, 40, {'type': 'CB_MCCB', 'name': 'MCCB', 'state': 'LIVE', 'voltage': 0.4, 'color': '#059669'}))
    cells.append(make_cell('load-b2', 'sld.Load', 473, 680, 34, 36, {'type': 'LOAD', 'name': '부하', 'color': '#059669'}))
    cells.append(make_link('link-busb-mccbb2', 'bus-04-b', 'p2', 'mccb-b2', 'in', '#059669'))
    cells.append(make_link('link-mccbb2-loadb2', 'mccb-b2', 'out', 'load-b2', 'in', '#059669'))

    cells.append(make_cell('mccb-b3', 'sld.MCCB', 536, 615, 28, 40, {'type': 'CB_MCCB', 'name': 'MCCB', 'state': 'LIVE', 'voltage': 0.4, 'color': '#059669'}))
    cells.append(make_cell('load-b3', 'sld.Load', 533, 680, 34, 36, {'type': 'LOAD', 'name': '부하', 'color': '#059669'}))
    cells.append(make_link('link-busb-mccbb3', 'bus-04-b', 'p3', 'mccb-b3', 'in', '#059669'))
    cells.append(make_link('link-mccbb3-loadb3', 'mccb-b3', 'out', 'load-b3', 'in', '#059669'))
    ...
    cells.append(make_cell(
        ...
        {'type': 'TR_2W', 'name': '22.9/0.4kV TR#4', 'priVoltage': 22.9, 'secVoltage': 0.4, 'connection': 'Δ-Y', 'capacity': '1000kVA', 'color': '#059669'}
    ))
    ...
    cells.append(make_cell(
        ...
        {'type': 'BUSBAR', 'name': '0.4kV 모선 (C)', 'voltage': 0.4, 'voltageUnit': 'kV', 'color': '#059669'},
    ...
    cells.append(make_link('link-tr4-bus04c', 'tr-4', 'sec', 'bus-04-c', 'p_tr', '#059669'))

    # Sub-loads on Bus C (Columns: 640, 700, 760)
    cells.append(make_cell('mccb-c1', 'sld.MCCB', 626, 615, 28, 40, {'type': 'CB_MCCB', 'name': 'MCCB', 'state': 'LIVE', 'voltage': 0.4, 'color': '#059669'}))
    cells.append(make_cell('load-c1', 'sld.Load', 623, 680, 34, 36, {'type': 'LOAD', 'name': '부하', 'color': '#059669'}))
    cells.append(make_link('link-busc-mccbc1', 'bus-04-c', 'p1', 'mccb-c1', 'in', '#059669'))
    cells.append(make_link('link-mccbc1-loadc1', 'mccb-c1', 'out', 'load-c1', 'in', '#059669'))

    cells.append(make_cell('mccb-c2', 'sld.MCCB', 686, 615, 28, 40, {'type': 'CB_MCCB', 'name': 'MCCB', 'state': 'LIVE', 'voltage': 0.4, 'color': '#059669'}))
    cells.append(make_cell('load-c2', 'sld.Load', 683, 680, 34, 36, {'type': 'LOAD', 'name': '부하', 'color': '#059669'}))
    cells.append(make_link('link-busc-mccbc2', 'bus-04-c', 'p2', 'mccb-c2', 'in', '#059669'))
    cells.append(make_link('link-mccbc2-loadc2', 'mccb-c2', 'out', 'load-c2', 'in', '#059669'))

    cells.append(make_cell('mccb-c3', 'sld.MCCB', 746, 615, 28, 40, {'type': 'CB_MCCB', 'name': 'MCCB', 'state': 'LIVE', 'voltage': 0.4, 'color': '#059669'}))
    cells.append(make_cell('load-c3', 'sld.Load', 743, 680, 34, 36, {'type': 'LOAD', 'name': '부하', 'color': '#059669'}))
    cells.append(make_link('link-busc-mccbc3', 'bus-04-c', 'p3', 'mccb-c3', 'in', '#059669'))
    cells.append(make_link('link-mccbc3-loadc3', 'mccb-c3', 'out', 'load-c3', 'in', '#059669'))
    ...
    cells.append(make_cell(
        ...
        {'type': 'TEXT_LABEL', 'text': '상용 전원 AC 3Φ 380V', 'color': '#059669'}
    ))
    cells.append(make_cell(
        'acb-ups-in', 'sld.ACB', 206, 810, 28, 40,
        {'type': 'CB_ACB', 'name': 'ACB', 'state': 'LIVE', 'voltage': 0.38, 'color': '#059669'}
    ))
    cells.append(make_cell(
    ...
    cells.append(make_cell(
        ...
        {'type': 'SWITCHGEAR', 'name': 'UPS 배전반', 'color': '#059669'}
    ))
    ...
    cells.append(make_cell(
        ...
        {'type': 'BUSBAR', 'name': 'UPS 모선 (380V)', 'voltage': 0.38, 'voltageUnit': 'kV', 'color': '#059669'},
        ports_config=bus_ups_ports
    ))

    # UPS Sub-loads (Columns: 570, 650)
    cells.append(make_cell('mccb-ups1', 'sld.MCCB', 556, 860, 28, 40, {'type': 'CB_MCCB', 'name': 'MCCB', 'state': 'LIVE', 'voltage': 0.38, 'color': '#059669'}))
    cells.append(make_cell('load-ups1', 'sld.Load', 553, 925, 34, 36, {'type': 'LOAD', 'name': '중요 부하 1', 'color': '#059669'}))
    cells.append(make_cell('mccb-ups2', 'sld.MCCB', 636, 860, 28, 40, {'type': 'CB_MCCB', 'name': 'MCCB', 'state': 'LIVE', 'voltage': 0.38, 'color': '#059669'}))
    cells.append(make_cell('load-ups2', 'sld.Load', 633, 925, 34, 36, {'type': 'LOAD', 'name': '중요 부하 2', 'color': '#059669'}))

    # UPS Links (All straight lines)
    cells.append(make_link('link-acbups-ups', 'acb-ups-in', 'out', 'ups-1', 'ac_in', '#059669'))
    cells.append(make_link('link-bat-ups', 'battery-1', 'out', 'ups-1', 'dc_bat', '#EA580C'))
    cells.append(make_link('link-ups-swg', 'ups-1', 'ac_out', 'swg-ups', 'in', '#059669'))
    cells.append(make_link('link-swg-busups', 'swg-ups', 'out', 'bus-ups', 'p_in', '#059669'))
    cells.append(make_link('link-busups-mccb1', 'bus-ups', 'p1', 'mccb-ups1', 'in', '#059669'))
    cells.append(make_link('link-mccb1-loadups1', 'mccb-ups1', 'out', 'load-ups1', 'in', '#059669'))
    cells.append(make_link('link-busups-mccb2', 'bus-ups', 'p2', 'mccb-ups2', 'in', '#059669'))
    cells.append(make_link('link-mccb2-loadups2', 'mccb-ups2', 'out', 'load-ups2', 'in', '#059669'))
