...
const EQUIPMENT_CATALOG = {
    ...
    TRANSMISSION_TOWER: {
        ...
        ports: ['out'],
        iconSvg: '<path d="M12 2L4 22h16L12 2zm0 6l5 12H7l5-12zM2 14h20M5 18h14" stroke="currentColor" stroke-width="1.5" fill="none" stroke-linecap="round"/>'
    },
    TR_2W: {
        type: 'TR_2W',
        ...
        ports: ['pri', 'sec'],
        iconSvg: '<circle cx="12" cy="8" r="5" stroke="currentColor" stroke-width="1.5" fill="none"/><circle cx="12" cy="16" r="5" stroke="currentColor" stroke-width="1.5" fill="none"/>'
    },
    TR_3W: {
        type: 'TR_3W',
        ...
        ports: ['pri', 'sec', 'tert'],
        iconSvg: '<circle cx="12" cy="7" r="4" stroke="currentColor" stroke-width="1.5" fill="none"/><circle cx="7" cy="16" r="4" stroke="currentColor" stroke-width="1.5" fill="none"/><circle cx="17" cy="16" r="4" stroke="currentColor" stroke-width="1.5" fill="none"/>'
    },
    CB_GCB: {
        type: 'CB_GCB',
        ...
        ports: ['in', 'out'],
        iconSvg: '<rect x="6" y="4" width="12" height="16" rx="2" stroke="currentColor" stroke-width="1.5" fill="none"/><path d="M12 4v4M12 16v4M8 12h8" stroke="currentColor" stroke-width="1.5"/>'
    },
    DS: {
        type: 'DS',
        ...
        ports: ['in', 'out'],
        iconSvg: '<path d="M12 3v5M12 16v5M12 8l4 6M12 14h2" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" fill="none"/><circle cx="12" cy="8" r="1.5" fill="currentColor"/><circle cx="12" cy="16" r="1.5" fill="currentColor"/>'
    },
    LA: {
        type: 'LA',
        ...
        ports: ['in', 'ground'],
        iconSvg: '<path d="M12 2v6M9 8h6l-3 4h4l-5 6h4l-3 4" stroke="currentColor" stroke-width="1.5" fill="none" stroke-linecap="round"/>'
    },
    ...
    CB_ACB: {
        ...
        ports: ['in', 'out'],
        iconSvg: '<rect x="5" y="4" width="14" height="16" rx="2" stroke="currentColor" stroke-width="1.5" fill="none"/><text x="12" y="14" text-anchor="middle" font-size="7" font-weight="bold" fill="currentColor">ACB</text>'
    },
    CB_VCB: {
        type: 'CB_VCB',
        jointType: 'sld.Breaker',
        ...
        ports: ['in', 'out'],
        iconSvg: '<rect x="5" y="4" width="14" height="16" rx="2" stroke="currentColor" stroke-width="1.5" fill="none"/><text x="12" y="14" text-anchor="middle" font-size="7" font-weight="bold" fill="currentColor">VCB</text>'
    },
    CB_MCCB: {
        type: 'CB_MCCB',
        jointType: 'sld.Breaker',
        ...
        ports: ['in', 'out'],
        iconSvg: '<rect x="6" y="4" width="12" height="16" rx="1.5" stroke="currentColor" stroke-width="1.5" fill="none"/><path d="M9 8h6M9 16h6M12 8v8" stroke="currentColor" stroke-width="1.2"/>'
    },
    FUSE: {
        type: 'FUSE',
        jointType: 'sld.Fuse',
        ...
        ports: ['in', 'out'],
        iconSvg: '<path d="M12 3v4M12 17v4" stroke="currentColor" stroke-width="1.5"/><rect x="7" y="7" width="10" height="10" rx="1" stroke="currentColor" stroke-width="1.5" fill="none"/><path d="M12 7v10" stroke="currentColor" stroke-width="1.5"/>'
    },
    RELAY: {
        type: 'RELAY',
        jointType: 'sld.Relay',
        ...
        ports: ['in', 'signal'],
        iconSvg: '<rect x="4" y="4" width="16" height="16" rx="2" stroke="currentColor" stroke-width="1.5" fill="none"/><text x="12" y="14" text-anchor="middle" font-size="6.5" font-weight="bold" fill="currentColor">51</text>'
    },
    CT: {
        type: 'CT',
        jointType: 'sld.CT',
        ...
        ports: ['in', 'out', 'sec'],
        iconSvg: '<circle cx="12" cy="12" r="6" stroke="currentColor" stroke-width="1.5" fill="none"/><path d="M6 12h12M12 3v3M12 18v3" stroke="currentColor" stroke-width="1.5"/>'
    },
    PT: {
        type: 'PT',
        jointType: 'sld.PT',
        ...
        ports: ['pri', 'sec'],
        iconSvg: '<circle cx="12" cy="9" r="4.5" stroke="currentColor" stroke-width="1.5" fill="none"/><circle cx="12" cy="15" r="4.5" stroke="currentColor" stroke-width="1.5" fill="none"/>'
    },
    GROUND_SWITCH: {
        type: 'GROUND_SWITCH',
        ...
        ports: ['in'],
        iconSvg: '<path d="M12 3v6M12 9l5 4M12 15v3M7 18h10M9 20h6M11 22h2" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" fill="none"/>'
    },
    ...
    BUSBAR: {
        ...
        iconSvg: '<rect x="2" y="10" width="20" height="4" rx="1" fill="currentColor"/><circle cx="5" cy="12" r="1.5" fill="#fff"/><circle cx="12" cy="12" r="1.5" fill="#fff"/><circle cx="19" cy="12" r="1.5" fill="#fff"/>'
    },
    SWITCHGEAR: {
        type: 'SWITCHGEAR',
        ...
        iconSvg: '<rect x="4" y="3" width="16" height="18" rx="2" stroke="currentColor" stroke-width="1.5" fill="none"/><line x1="4" y1="10" x2="20" y2="10" stroke="currentColor" stroke-width="1.2"/><line x1="4" y1="16" x2="20" y2="16" stroke="currentColor" stroke-width="1.2"/><circle cx="8" cy="6.5" r="1" fill="currentColor"/><circle cx="8" cy="13" r="1" fill="currentColor"/>'
    },
    PANELBOARD: {
        type: 'PANELBOARD',
        ...
        ports: ['in', 'out1', 'out2'],
        iconSvg: '<rect x="5" y="4" width="14" height="16" rx="1.5" stroke="currentColor" stroke-width="1.5" fill="none"/><rect x="8" y="7" width="8" height="10" stroke="currentColor" stroke-width="1" fill="none"/>'
    },
    MOTOR: {
        type: 'MOTOR',
        jointType: 'sld.Motor',
        ...
        ports: ['in'],
        iconSvg: '<circle cx="12" cy="12" r="8" stroke="currentColor" stroke-width="1.5" fill="none"/><text x="12" y="15" text-anchor="middle" font-size="9" font-weight="bold" fill="currentColor">M</text>'
    },
    LOAD: {
        type: 'LOAD',
        jointType: 'sld.Load',
        ...
        ports: ['in'],
        iconSvg: '<rect x="5" y="7" width="14" height="10" rx="1" stroke="currentColor" stroke-width="1.5" fill="none"/><path d="M12 2v5M12 17v5" stroke="currentColor" stroke-width="1.5"/><text x="12" y="14.5" text-anchor="middle" font-size="6" font-weight="bold" fill="currentColor">부하</text>'
    },
    ...
    UPS: {
        ...
        iconSvg: '<rect x="3" y="5" width="18" height="14" rx="2" stroke="currentColor" stroke-width="1.5" fill="none"/><line x1="3" y1="19" x2="21" y2="5" stroke="currentColor" stroke-width="1"/><path d="M6 10q2-3 4 0t4 0" stroke="currentColor" stroke-width="1.2" fill="none"/><text x="15" y="16" font-size="6" font-weight="bold" fill="currentColor">=</text>'
    },
    RECTIFIER: {
        type: 'RECTIFIER',
        ...
        ports: ['ac_in', 'dc_out'],
        iconSvg: '<rect x="4" y="5" width="16" height="14" rx="2" stroke="currentColor" stroke-width="1.5" fill="none"/><line x1="4" y1="19" x2="20" y2="5" stroke="currentColor" stroke-width="1"/><path d="M7 10q1.5-2 3 0t3 0" stroke="currentColor" stroke-width="1" fill="none"/><line x1="14" y1="14" x2="17" y2="14" stroke="currentColor" stroke-width="1.2"/>'
    },
    BATTERY: {
        type: 'BATTERY',
    ...
    GENERATOR: {
        ...
        ports: ['out'],
        iconSvg: '<circle cx="12" cy="12" r="8" stroke="currentColor" stroke-width="1.5" fill="none"/><text x="12" y="15" text-anchor="middle" font-size="9" font-weight="bold" fill="currentColor">G</text>'
    },
    ...
    GROUND: {
        ...
        ports: ['in'],
        iconSvg: '<path d="M12 4v8M6 12h12M8 15h8M10 18h4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" fill="none"/>'
    },
    JUNCTION: {
        type: 'JUNCTION',
        ...
        ports: ['p1', 'p2', 'p3', 'p4'],
        iconSvg: '<circle cx="12" cy="12" r="4" fill="currentColor"/><path d="M12 2v6M12 16v6M2 12h6M16 12h6" stroke="currentColor" stroke-width="1.5"/>'
    },
    TEXT_LABEL: {
        type: 'TEXT_LABEL',
        ...
        ports: [],
        iconSvg: '<path d="M5 5h14M12 5v14M8 19h8" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/>'
    },
    GROUP_BOX: {
        type: 'GROUP_BOX',
        ...
        ports: [],
        iconSvg: '<rect x="3" y="3" width="18" height="18" rx="2" stroke="currentColor" stroke-width="1.5" stroke-dasharray="3,2" fill="none"/><path d="M6 7h8" stroke="currentColor" stroke-width="1.2"/>'
    }
};
